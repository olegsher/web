...
<i> <img src="images/Thrifty-Israel.jpg" alt="машина прокат, машина прокат Израиле, аренда машины Израиль" class="img-responsive" /></i>
		<h3>БРОНИРОВАНИЕ АВТОМОБИЛЯ В ИЗРАИЛЕ ЗА ОДИН ШАГ</h3>
                ...
                <hr />
                <p style="float:left; color:grey; font-weight: bold; font-size: large" ><a  href="http://www.rentcarisrael.online/minivan.php">Прокат минивэнов - наш бизнес</a> </p>
                <hr />
                <p style="float:left; color:grey; font-weight: bold; font-size: large" ><a  href="http://www.rentcarisrael.online/tours.php">Акция для клиентов - Частный гид за 250$</a> </p>
                <hr />
                <p style="float:left; color:grey; font-weight: bold; font-size: large" ><a  href="http://www.rentcarisrael.online/transfer.php">Частный трансфер из аэропорта Бен Гурион начиная от 60$</a> </p>
                
                <hr />
                <p style="float:left; color:grey; font-weight: bold; font-size: large" >Отделения во всех крупных городах Израиля </p>
                <hr />
			...
			<div class="bnr-left">
				<label class="inputLabel">Выбирайте класс автомобиля</label>
						 ...
						 <select onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Выбирайте машину';}" name="car-select" id="car-select" required = "required" autofocus>
							...
							<option value="Category I" >Mazda 3(автомат) или похожая в категории I - от 32$ в сутки(франшиза - 475$)</option>
